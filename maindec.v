module maindec(input  [6:0] op,
  ...
  always @* case(op)
    // RegWrite_ImmSrc_ALUSrc_MemWrite_ResultSrc_Branch_ALUOp_Jump_RegWriteFP_FPOp
      ...
      7'b0000111: controls = 13'b0_00_1_0_01_0_00_0_1_0; // flw (FP load word)
      7'b0100111: controls = 13'b0_01_1_1_00_0_00_0_1_0; // fsw (FP store word) - FPOp=1 para leer de frf
      7'b1010011: controls = 13'b0_xx_0_0_00_0_00_0_1_1; // FP R-type (fadd, fsub, fmul, fdiv, etc.)
