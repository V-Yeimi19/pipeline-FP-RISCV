// ALU para operaciones de enteros RISC-V
// Compatible con la interfaz del pipeline
...
module alu_int(
  ...
  always @* case (alucontrol)
      ...
      3'b101:  result_reg = sum[31] ^ v; // slt (set less than)
      3'b110:  result_reg = a << b[4:0]; // sll (shift left logical)
      3'b111:  result_reg = a >> b[4:0]; // srl (shift right logical)
